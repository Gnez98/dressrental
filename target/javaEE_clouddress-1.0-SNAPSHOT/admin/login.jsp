...
<div class="loginmanage">
    <div class="py-container">
        <h4 class="manage-title">礼服租赁系统</h4>
        <div class="loginform">
            ...
            <div class="tab-content tab-wraped">
                ...
                <div id="profile" class="tab-pane  active">
                    <form id="loginform" class="sui-form" action="${pageContext.request.contextPath}/consumer/login"
                          method="post">
                        <div class="input-prepend"><span class="add-on loginname">账号</span>
                            <input type="text" placeholder="用户邮箱" class="span2 input-xfat" name="email">
                        </div>
